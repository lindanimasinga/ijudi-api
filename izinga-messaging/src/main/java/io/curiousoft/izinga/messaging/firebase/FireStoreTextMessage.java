...
/**
 * Message model moved from io.curiousoft.izinga.messaging.chat to WhatsApp messaging package.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class FireStoreTextMessage {
    ...
    public static FireStoreTextMessage fromMap(Map<String, Object> map) {
        if (map == null) return null;
        FireStoreTextMessage msg = new FireStoreTextMessage();
        Object v;
        v = map.get("createdAt");
